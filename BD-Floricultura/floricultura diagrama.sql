...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `floricultura` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT INTO `compras` (`Cliente_idCliente`, `Flores_idFlores`) VALUES (1,2),(2,1),(2,3),(3,4);
...
INSERT INTO `distribuicao` (`Flores_idFlores`, `Fornecedor_idFornecedor`) VALUES (1,2),(2,3),(3,2),(4,1);
...
INSERT INTO `entregas` (`idEntregas`, `produto`, `local`, `Funcionario_matricula`) VALUES (1,'Rosas','Rua 5 casa 5',101010),(2,'margarida','Rua 6 casa 7',202020),(3,'Orquidea','Rua 7 casa 6',303030);
...
INSERT INTO `flores` (`idFlores`, `nome`, `valorVenda`) VALUES (1,'Orquideas',20.99),(2,'Rosas',15.99),(3,'Tulipas',20),(4,'Margaridas',25.1);
...
INSERT INTO `vendas` (`Flores_idFlores`, `Funcionario_matricula`) VALUES (1,303030),(2,101010),(3,303030),(4,101010);
...
-- Dump completed on 2023-06-12 16:54:58
